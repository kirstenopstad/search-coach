            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Stage = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PhoneScreen = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Interview1 = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Interview2 = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    WhiteBoarding = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Offer = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResumeURL = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CoverLetterURL = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsRemote = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IsHybrid = table.Column<bool>(type: "tinyint(1)", nullable: false),
